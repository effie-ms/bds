...
MANAGERS = ADMINS
EMAIL_SUBJECT_PREFIX = "[bds] "  # subject prefix for managers & admins

SESSION_COOKIE_NAME = "bds_ssid"
...
DATABASES = {
    ...
    "default": env.db_url(
        ...
        default="psql://{user}:{password}@{host}:{port}/{name}?sslmode={sslmode}".format(
            ...
            name=quote(env.str("DJANGO_DATABASE_NAME", default="bds")),
            user=quote(env.str("DJANGO_DATABASE_USER", default="bds")),
            password=quote(env.str("DJANGO_DATABASE_PASSWORD", default="bds")),
...
# Email config
DEFAULT_FROM_EMAIL = "bds <info@TODO.com>"
SERVER_EMAIL = "bds server <server@TODO.com>"
