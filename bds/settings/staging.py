...
ALLOWED_HOSTS = env.list(
    ...
    default=["office.bds.test.TODO.com", "bds.test.TODO.com"],

)
# fmt: on

# Static site url, used when we need absolute url but lack request object, e.g. in email sending.
SITE_URL = env.str("RAZZLE_SITE_URL", default="https://bds.test.TODO.com")
DJANGO_SITE_URL = env.str(
    "RAZZLE_BACKEND_SITE_URL", default="https://office.bds.test.TODO.com"
)

# fmt: off
CSRF_COOKIE_DOMAIN = env.str(
    "DJANGO_CSRF_COOKIE_DOMAIN",
    default=".bds.test.TODO.com"
)
# fmt: on
    ...
    LOGGING["handlers"].update(
        {
            "info_log": {
                ...
                "filename": "/var/log/bds/info.log",
                "formatter": "default",
            },
            "error_log": {
                "level": "ERROR",
                "class": "logging.handlers.WatchedFileHandler",
                "filename": "/var/log/bds/error.log",
                "formatter": "default",
            },
        }
    )
...
# Enable S3 storage
DEFAULT_FILE_STORAGE = "bds.storages.MediaStorage"
MEDIA_ROOT = env.str("DJANGO_MEDIA_ROOT", default="")
AWS_STORAGE_BUCKET_NAME = env.str(
    "DJANGO_AWS_STORAGE_BUCKET_NAME", default="bds-staging"
)
